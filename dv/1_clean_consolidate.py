...
num_samples = 60
processed_data = np.array(["accel_mean", "gyro_mean", "accel_stddev", "gyro_stddev", "activity"])
...
for filepath in csv_files:
    ...
    batch = np.stack((accel_mean, gyro_mean, accel_stddev, gyro_stddev, activity), axis=1)
